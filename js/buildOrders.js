...
const BUILD_ORDERS = [
  ...
  },
  {
    ...
    benchmarks: [
      "Feudal at 28-29 pop (~12:45)",
      "Stable + Blacksmith down immediately in Feudal",
      "2 Knights out by ~16:45",
      "Bloodlines + Husbandry researched by ~18:00",
    ],
  ...
  },
  {
    ...
    summary: "Get to Castle Age quickly and build 2-3 Town Centers to boom economy. Economic strategy for long-term domination.",
    difficulty: "intermediate",
    popCount: "30",
    clickUpTime: "~14:30",
    clickUpLabel: "Castle",
    steps: [
      { pop: "1-6",  age: "dark",   task: "6 villagers to sheep", food: 6, wood: 0, gold: 0 },
      { type: "helper", task: "Build 2 Houses with your 3 starting villagers (2/1)" },
      { pop: "7",    age: "dark",   task: "1 villager to wood (build Lumber Camp)", food: 6, wood: 1, gold: 0 },
      { pop: "8-10", age: "dark",   task: "3 villagers to wood", food: 6, wood: 4, gold: 0 },
      { pop: "11",   age: "dark",   task: "Lure 1st boar", food: 7, wood: 4, gold: 0 },
      { type: "helper", task: "Build 2 Houses near berries" },
      { pop: "12",   age: "dark",   task: "1 villager to berries (build Mill)", food: 8, wood: 4, gold: 0 },
      { pop: "13-14", age: "dark",  task: "2 more villagers to berries (3 total on berries)", food: 10, wood: 4, gold: 0 },
      { type: "helper", task: "Lure 2nd boar" },
      { pop: "15-16", age: "dark",  task: "2 more villagers to berries (5 total on berries)", food: 12, wood: 4, gold: 0 },
      { pop: "17-21", age: "dark",  task: "5 villagers to farms", food: 17, wood: 4, gold: 0 },
      { pop: "22",   age: "dark",   task: "1 villager to wood (build 2nd Lumber Camp)", food: 17, wood: 5, gold: 0 },
      { pop: "23-26", age: "dark",  task: "4 villagers to wood", food: 17, wood: 9, gold: 0 },
      { type: "helper", task: "Build House" },
      { pop: "27",   age: "dark",   task: "1 villager to wood", food: 17, wood: 10, gold: 0 },
      { pop: "28",   age: "dark",   task: "1 villager to gold (build Mining Camp)", food: 17, wood: 10, gold: 1 },
      { pop: "29-30", age: "dark",  task: "2 villagers to gold", food: 17, wood: 10, gold: 3 },
      { type: "helper", task: "Move sheep villagers to farms as sheep deplete" },
      { pop: "30",   age: "dark",   task: "Click Feudal Age", isBenchmark: true },
      { type: "helper", task: "Build Blacksmith (1 villager from wood)" },
      { type: "helper", task: "Build Market (2 villagers from wood)" },
      { pop: null,   age: "feudal", task: "Research Double-Bit Axe in Lumber Camp" },
      { type: "helper", task: "Build House" },
      { pop: "31",   age: "feudal", task: "1 villager to wood", food: 18, wood: 10, gold: 3 },
      { pop: null,   age: "feudal", task: "Click Castle Age", isBenchmark: true },
      { pop: null,   age: "feudal", task: "Research Horse Collar in Mill" },
      { type: "helper", task: "Move 2 villagers from berries to wood", food: 20, wood: 8, gold: 3 },
      { pop: null,   age: "castle", task: "Build 2nd Town Center with 4 villagers from one woodline" },
      { pop: null,   age: "castle", task: "Build 3rd Town Center with 4 villagers from other woodline" },
      { type: "helper", task: "(Optional) Buy 100 Stone at Market for 4th Town Center" },
      { type: "helper", task: "Move berry villagers to farms as berries deplete" },
      { pop: null,   age: "castle", task: "Build many farms continuously" },
      { pop: null,   age: "castle", task: "Build many houses to reach population limit" },
    ],
    benchmarks: [
      "Feudal at 30 pop (~13:30)",
      "Market + Blacksmith down in Feudal",
      "Castle Age by ~16:00",
      "2-3 TCs down immediately in Castle Age",
    ],
    followUp: "Build 2-3 additional Town Centers in Castle Age and mass villagers. Add farms continuously. Transition to military once you have strong economy (40-50+ villagers). Can go Knights, Crossbows, or unique units.",
  },
];
